...
namespace PetInsightsv2
{
    ...
    public class AddContentActivity : AppCompatActivity, IOnSuccessListener, IOnFailureListener /*Activity too? */
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.add_content); // DOESNT WORK
