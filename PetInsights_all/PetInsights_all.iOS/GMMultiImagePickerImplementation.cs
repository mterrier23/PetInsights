...
using CoreGraphics;
using GMImagePicker;
using PetInsights_all;
using PetInsights_all.iOS;
using Photos;
using Xamarin.Forms;
using Xamarin.Forms.Platform.iOS;

[assembly: Dependency(typeof(GMMultiImagePickerImplementation))]
namespace PetInsights_all.iOS
{
    [Foundation.Preserve(AllMembers = true)]
    public class GMMultiImagePickerImplementation : IGMMultiImagePicker
    {
